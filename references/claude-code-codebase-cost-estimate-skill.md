---
type: reference
title: "Claude Code: Codebase Cost Estimate Skill"
description: Claude Code cost-estimate command that analyzes a codebase to estimate development hours, market-rate cost, full-team cost, calendar time, and Claude ROI per active hour.
tags:
  - claude-code
  - reference
---
# Claude Code: Codebase Cost Estimate Skill
